...
def check_nsp(dist, attr, value):
    ...
    for nsp in ns_packages:
        if not dist.has_contents_for(nsp):
            raise DistutilsSetupError(
                "Distribution contains no classes or packages for " +
...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    commands that add or remove packages, classes, extensions, and so on from
    ...
    def exclude_package(self, package):
        """Remove packages, classes, and extensions in named package"""
    ...
    def exclude(self, **attrs):
        ...
        packages, classes, and extensions are also excluded.
    ...
    def iter_distribution_names(self):
        """Yield all packages, classes, and extension names in distribution"""
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         list.  (Note: the named package(s) or classes must exist in the base
        ...
        for item in self.remove:
            if not dist.has_contents_for(item):
                raise DistutilsSetupError(
                    ...
                    " doesn't contain any packages or classes under %s"
