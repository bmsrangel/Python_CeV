...
def get_include():
    ...
    Extension classes that need to compile against NumPy should use this
...
def info(object=None, maxwidth=76, output=sys.stdout, toplevel='numpy'):
    ...
    object : object or str, optional
        ...
        classes are searched for matching objects.  If None, information
...
def lookfor(what, module=None, import_modules=True, regenerate=False,
    ...
    import_modules : bool, optional
        Whether to import sub-classes in packages. Default is True.
...
def _lookfor_generate_cache(module, import_modules, regenerate):
    ...
    import_modules : bool
        Whether to import sub-classes in packages.
    regenerate : bool
