...
# Pete Shinners
# pete@shinners.org
"""Pygame is a set of Python classes designed for writing games.
...
# our classes is with the import command (not the __import__ function)

# first, the "required" classes
...
# lastly, the "optional" pygame classes
...
# there's also a couple "internal" classes not needed
