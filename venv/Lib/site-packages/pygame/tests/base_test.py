...
class BaseModuleTest(unittest.TestCase):
    ...
    def test_quit__and_init(self):
        # __doc__ (as of 2008-06-25) for pygame.base.quit:
          ...
          # uninitialize all pygame classes
    ...
    def test_init(self):
        ...
        # initialize all imported pygame classes
        #
        # Initialize all imported Pygame classes. No exceptions will be raised
        ...
        # individual classes manually, but pygame.init is a convenient way to
        # get everything started. The init() functions for individual classes
        # will raise exceptions when they fail.
        #
        # You may want to initalise the different classes seperately to speed
